...
void AddMenus(HWND hwnd)
{
    ...
    AppendMenuW(Spiling_list, MF_STRING, 21, L"Spiling");
    AppendMenuW(list_, MF_POPUP, (UINT_PTR)Spiling_list, L"Spiling");
    ...
    AppendMenuW(list_, MF_POPUP, (UINT_PTR)Clear_list, L"Clear");
    ...
    case WM_LBUTTONDOWN:
        ...
        else if(case_number >= 17 && case_number <= 20)
        {
          ...
          if (cnt <=9){
            ...
            if (cnt == 9)
            {
                DrawCardinalSpline(hdc,v,8,0.5,c);
                cnt=1;
                ReleaseDC(hwnd, hdc);
            }
        }
    ...
    case WM_RBUTTONDOWN:
        ...
        if(case_number>=25 && case_number<=29)
        {
            ...
            else if(case_number>=25 && case_number<=27 && cnt2==2) //rectangle
            {
                ...
                drawRectangle(hdc,x1,y1,d1,d2,col);
                ReleaseDC(hwnd,hdc);
                cnt2=0;
            }
        }
